import{a as U,I as _}from"./IconGallery-m-N1KbQG.js";import"./vue.esm-bundler-5YZkSDXG.js";import"./iframe-EP1b8QSM.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const M={title:"Atoms/Icon",component:_,tags:["autodocs"],argTypes:{source:{control:"radio",options:["font","svg"],description:"Origen del icono (fuente externa FontAwesome o SVG local)",table:{category:"Configuración"}},icon:{control:"text",description:"Nombre del icono (ej. 'house' o nombre del archivo SVG)",table:{category:"Configuración"}},type:{control:"select",options:["solid","regular","brands","colorful"],description:"Variante de la colección de iconos",table:{category:"Configuración"}},size:{control:"number",description:"Tamaño en píxeles. Si se omite, hereda del elemento padre.",table:{category:"Apariencia"}},rotate:{control:"number",description:"Rotación en grados",table:{category:"Apariencia"}},ariaLabel:{control:"text",description:"Etiqueta accesible para lectores de pantalla",table:{category:"Accesibilidad"}}},args:{source:"font",icon:"house",type:"solid"}},r={args:{source:"font",icon:"heart",type:"solid",size:48}},o={args:{source:"font",icon:"heart",type:"regular",size:48}},a={args:{source:"font",icon:"github",type:"brands",size:48}},s={args:{source:"svg",icon:"custom-star",type:"solid",size:64}},t={args:{source:"svg",icon:"custom-star",type:"regular",size:64}},n={render:e=>({setup(){return{args:e}},template:`
    ...
    `}),args:{source:"font",icon:"bell"}},l={args:{source:"font",icon:"arrow-right",rotate:90,size:32}},d={name:"Galería de Iconos Locales",render:()=>({components:{IconGallery:U},template:"<IconGallery />"}),parameters:{layout:"fullscreen",docs:{description:{story:'Lista interactiva de todos los iconos SVG locales disponibles en la librería. Usa el buscador para filtrar por nombre. Cada icono muestra su nombre (para usarlo en `icon="..."`) y las variantes disponibles.'}}}};var p,m,u;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    source: 'font',
    icon: 'heart',
    type: 'solid',
...
}`,...(P=(H=d.parameters)==null?void 0:H.docs)==null?void 0:P.source}}};const Q=["FontAwesomeSolid","FontAwesomeRegular","FontAwesomeBrands","SvgLocalSolid","SvgLocalRegular","SvgLocalColorful","VariantFallback","SizeInheritanceAndColor","Transformations","Gallery"];export{a as FontAwesomeBrands,o as FontAwesomeRegular,r as FontAwesomeSolid,d as Gallery,c as SizeInheritanceAndColor,n as SvgLocalColorful,t as SvgLocalRegular,s as SvgLocalSolid,l as Transformations,i as VariantFallback,Q as __namedExportsOrder,M as default};
